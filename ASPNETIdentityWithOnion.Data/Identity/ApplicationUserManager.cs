...
namespace ASPNETIdentityWithOnion.Data.Identity
{
    ...
    public class ApplicationUserManager : IApplicationUserManager
    {
        ...
        public virtual async Task SendEmailAsync(int userId, string subject, string body)
        {
            ...
            { Destination = await _userManager.GetEmailAsync(userId), Body = body, Subject = subject }).ConfigureAwait(false);
            //SendEmailAsync(userId, subject, body).ConfigureAwait(false);
            
        }
        //public virtual async Task SendEmailAsync(IdentityMessage message)s
        //{
